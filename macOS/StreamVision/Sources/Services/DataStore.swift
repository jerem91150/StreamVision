...
actor DataStore {
    ...
    init() {
        ...
        appSupportDir = appSupport.appendingPathComponent("StreamVision", isDirectory: true)
    ...
    func savePlaylistSources(_ sources: [PlaylistSource]) throws {
        let url = appSupportDir.appendingPathComponent("playlists.json")
    ...
    func saveChannels(_ channels: [Channel], forSourceId sourceId: UUID) throws {
        let url = appSupportDir.appendingPathComponent("channels_\(sourceId.uuidString).json")
    ...
    func saveFavorites(_ channelIds: Set<UUID>) throws {
        let url = appSupportDir.appendingPathComponent("favorites.json")
    ...
    func addRecentChannel(_ channelId: UUID) throws {
        ...
        let url = appSupportDir.appendingPathComponent("recent.json")
