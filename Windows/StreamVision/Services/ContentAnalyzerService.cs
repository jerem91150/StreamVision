        ...
        {
            {
                "French", new[]
                {
                    ...
                    new VersionPattern("FRANCE", ContentVersion.Dubbed, "France"),
                    ...
                    // Chaînes françaises communes
                    new VersionPattern("TF1", ContentVersion.Dubbed, "Français"),
                    new VersionPattern("CANAL", ContentVersion.Dubbed, "Français"),
                    new VersionPattern("ARTE", ContentVersion.Dubbed, "Français"),
                    new VersionPattern("M6", ContentVersion.Dubbed, "Français"),
                    new VersionPattern("W9", ContentVersion.Dubbed, "Français"),
                    new VersionPattern("TMC", ContentVersion.Dubbed, "Français"),
                    new VersionPattern("NRJ", ContentVersion.Dubbed, "Français"),
                    new VersionPattern("RMC", ContentVersion.Dubbed, "Français"),
                    new VersionPattern("BFM", ContentVersion.Dubbed, "Français"),
                    new VersionPattern("CNEWS", ContentVersion.Dubbed, "Français"),
                    new VersionPattern("BEIN", ContentVersion.Dubbed, "Français"),
                    new VersionPattern("OCS", ContentVersion.Dubbed, "Français"),
                    new VersionPattern("CINE+", ContentVersion.Dubbed, "Français"),
                    new VersionPattern("DISNEY", ContentVersion.Dubbed, "Français"),
                }
            },
            {
                "English", new[]
